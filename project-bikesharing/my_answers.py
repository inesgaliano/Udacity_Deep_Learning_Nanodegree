...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #output_error_term_2D = np.array(output_error_term, ndmin=2)
        #delta_weights_h_o_T = delta_weights_h_o.T
        #hidden_error = np.dot(output_error_term, delta_weights_h_o_T)
        ...
        #output_error_term_T = output_error_term.T
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        #changed learning_rate to self.lr in both:
